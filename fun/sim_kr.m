function [dataSim_kr, dataRaw_kr] = sim_kr(kr)
% Define qMT Model
Model = qmt_spgr;
...
for i=1:length(kr)
    ...
    dataSim_kr(:,1,i) = SimCurveResults.Offsets;
    dataSim_kr(:,2,i) = SimCurveResults.curve(:,1);
    dataSim_kr(:,3,i) = SimCurveResults.curve(:,2);
    dataRaw_kr(:,1,i) = Protocol.Offsets;
    dataRaw_kr(:,2,i) = data.MTdata;
end
end
